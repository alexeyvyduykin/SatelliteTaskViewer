...
namespace SatelliteTaskViewer.Avalonia.Renderer.OpenTK.Core
{
    ...
    blending.DestinationAlphaFactor);
        ...
        private static void VerifyDraw(DrawState drawState, SatelliteTaskViewer.Models.Scene.ISceneState sceneState)
        {
            if (drawState == null)
            {
        ...
        private void ApplyBeforeDraw(DrawState drawState, SatelliteTaskViewer.Models.Scene.ISceneState sceneState)
        {
        ...
        public void ApplyShaderProgram(DrawState drawState, SatelliteTaskViewer.Models.Scene.ISceneState _)
        {
        ...
        public void Draw(A.PrimitiveType primitiveType, DrawState drawState, SatelliteTaskViewer.Models.Scene.ISceneState sceneState)
        {
