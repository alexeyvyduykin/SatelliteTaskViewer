...
namespace SatelliteTaskViewer.Avalonia.Themes
{
    public class BlenderTheme : IStyle, IResourceProvider
    {
        ...
        private Uri GetUri() => new Uri("avares://SatelliteTaskViewer.Avalonia/Themes/BlenderDefaultTheme.axaml", UriKind.Absolute);
    }
}
