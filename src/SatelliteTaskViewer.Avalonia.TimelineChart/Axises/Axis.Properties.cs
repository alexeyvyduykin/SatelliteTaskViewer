...
namespace SatelliteTaskViewer.Avalonia.TimelineChart
{
    public partial class Axis
    {
        ...
        public static readonly StyledProperty<model.AxisPosition> PositionProperty =
            AvaloniaProperty.Register<Axis, model.AxisPosition>(nameof(Position), model.AxisPosition.Left);

        public model.AxisPosition Position
        {
            get
            {
