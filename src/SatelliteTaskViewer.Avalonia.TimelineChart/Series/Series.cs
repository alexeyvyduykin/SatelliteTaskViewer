...
namespace SatelliteTaskViewer.Avalonia.TimelineChart
{
    public abstract class Series : ItemsControl
    {
        ...
        public model.Series InternalSeries { get; protected set; }

        public abstract model.Series CreateModel();
        ...
        protected virtual void SynchronizeProperties(model.Series s)
        {
