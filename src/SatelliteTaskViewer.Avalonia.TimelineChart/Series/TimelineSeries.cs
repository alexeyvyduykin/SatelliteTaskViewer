...
{
    public class TimelineSeries : Series, model.IStackableSeries
    {
        ...
        {
            InternalSeries = new model.TimelineSeries();
        }
        ...
        public override model.Series CreateModel()
        {
        ...
        protected override void SynchronizeProperties(model.Series series)
        {
            ...
            var s = (model.TimelineSeries)series;
