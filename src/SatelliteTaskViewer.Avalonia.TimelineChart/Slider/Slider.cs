...
namespace SatelliteTaskViewer.Avalonia.TimelineChart
{
    public class Slider : Control
    {
        ...
        {
            if (Parent is model.IPlotView pc)
            {
                pc.InvalidatePlot(false);
            }
        }

        public void UpdateMinMax(model.PlotModel plotModel)
        {
            ...
            plotModel.GetAxesFromPoint(out model.Axis axisX, out _);
            ...
            foreach (model.XYAxisSeries item in plotModel.Series)
            {
