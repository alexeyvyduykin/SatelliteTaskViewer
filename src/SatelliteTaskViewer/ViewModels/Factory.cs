...
namespace SatelliteTaskViewer.ViewModels
{
    public class Factory : IFactory
    {
        ...
        public IList<(string Name, Satellite Satellite, IList<BaseSatelliteEvent> Events)> CreateSatelliteTasks(IList<Satellite> satellites, ScenarioData data)
        {
            ...
            for (int i = 0; i < satellites.Count; i++)
            {
                ...
                list.Add((name, satellites[i], events));
            }
